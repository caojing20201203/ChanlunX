...
enum class FenXingType { NONE, TOP, BOTTOM, FAILURE_TOP, FAILUER_TOP_VERIFY_BOTTOM_BOTTOM, FAILURE_BOTTOM, FAILURE_BOTTOM_VERIFY_TOP_TOP, VERIFY_TOP, VERIFY_BOTTOM, FAILURE_VERIFY_TOP, FAILURE_VERIFY_BOTTOM, NEW_TOP, NEW_BOTTOM };
