...
enum class XianDuanChuLiStatus { START, LEFT, AFTER_LEFT, MIDDLE_HIGHLOW, MIDDLE_NORMAL, LEFT_INCLUDE_MIDDLE, LEFTINCLUDEMIDDLE_RIGHT, LEFTINCLUDEMIDDLE_AFTER_RIGHT, LEFTINCLUDEMIDDLE_FREE, AFTER_MIDDLE, RIGHT, AFTER_RIGHT, FREE, AFTER_FREE, AFTER_FREE_NORMAL, AFTER_FREE_NORMAL_NORMAL, LONGXIANDUAN, LONGXIANDUAN_RIGHT, LONGXIANDUAN_AFTER_RIGHT, LONGXIANDUAN_FREE, LONGXIANDUAN_AFTER_FREE, LONGXIANDUAN_AFTER_FREE_1 };
